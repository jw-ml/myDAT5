...
auto[['mpg', 'car_name']].sort_index(by='mpg', ascending=False).head()

# returns the 5 cars with > 4 cylinders that have the best mpg
auto[['mpg', 'cylinders', 'car_name']][auto.cylinders > 4].sort_index(by='mpg', ascending=False).head()

# returns the 5 cars with the worst gas mileage
auto[['mpg', 'car_name']].sort_index(by='mpg').head()

# returns the 5 cars with <= 4 cylinders that get the worst mpg
auto[['mpg', 'cylinders', 'car_name']][auto.cylinders <= 4].sort_index(by='mpg').head()
