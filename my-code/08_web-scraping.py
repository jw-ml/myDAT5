...
<body>
  ...
  <p id="intro">My name is Brandon.  I'm web scraping!</p>
...
# 1. Extract the 'h3' element from Brandon's webpage.
h3 = b.find(name='h3')
h3.text
...
for hobby in hobbies:
    print str(hobby.text)

# 3. Extract Brandon's hobby that has the id "my favorite".
fav = b.find(name='li', attrs={'id': 'my favorite'})
print str(fav.text)
...
img = body.find('img') # Find the image tags ~~> NOTE: Do not have to use name='img'
img
type(img)
...
# Now let's talk about 'attrs'
# Beautiful soup also allows us to choose tags with specific attributes
# ~~> copied from webpage: <span class="itemprop" itemprop="name">House of Cards</span>
...
# ~~> copied from webpage: <div class="titlePageSprite star-box-giga-star"> 9.1 </div>
...
duration = infobar.find(name="time", attrs={"itemprop":"duration"}).text.strip()

# Retrieve the show's genre
genre = infobar.find(name="span", attrs={"class":"itemprop", "itemprop":"genre"}).text
...
#<a href="/name/nm0000228/?ref_=tt_ov_st" itemprop="url"><span class="itemprop" itemprop="name">Kevin Spacey</span></a>, 
#<a href="/name/nm0318703/?ref_=tt_ov_st" itemprop="url"><span class="itemprop" itemprop="name">Michael Gill</span></a>, 
#<a href="/name/nm0000705/?ref_=tt_ov_st" itemprop="url"><span class="itemprop" itemprop="name">Robin Wright</span></a>                          <span class="ghost">|</span>
