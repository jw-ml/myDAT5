...
drinks[(drinks.country=='Haiti') | (drinks.country=='Belarus')][['country', 'spirit_servings']]
# Belarus
...
# of pure alcohol? 
drinks[(drinks.wine_servings > 300) | (drinks.beer_servings > 300) | (drinks.spirit_servings > 300)].total_litres_of_pure_alcohol.mean()
# 10.26111
...
drinks.sort_index(by=['beer_servings', 'wine_servings']).head(30)  # sort by multiple columns
...
spirit_filter = drinks.spirit_servings > drinks.spirit_servings.mean()
drinks[spirit_filter].groupby('continent').wine_servings.mean()
...
# servings?
beer_filt = drinks.beer_servings > drinks.beer_servings.mean()
drinks[beer_filt].groupby('continent').wine_servings.mean()
